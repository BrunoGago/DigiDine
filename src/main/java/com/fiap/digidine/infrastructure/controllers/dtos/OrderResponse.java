...
public record OrderResponse(long orderNumber, Long customerNumber, List<Long> productsNumber, double totalPrice, OrderStatus orderStatus, LocalDateTime createdAt) {
}
